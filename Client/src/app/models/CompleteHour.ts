export class CompleteHour{
  constructor(private _hour_approved:string,
              ...
              private _id:number,
              private _hour_project_name:string,
              private _hour_subproject_name:string,
              private _hour_employee_first_name:string,
              private _hour_employee_last_name:string,
              private _hour_client_name:string){

  }


  get hour_employee_first_name(): string {
    return this._hour_employee_first_name;
  }

  set hour_employee_first_name(value: string) {
    this._hour_employee_first_name = value;
  }

  get hour_employee_last_name(): string {
    return this._hour_employee_last_name;
  }

  set hour_employee_last_name(value: string) {
    this._hour_employee_last_name = value;
  }

  get hour_project_name(): string {
    return this._hour_project_name;
  }

  set hour_project_name(value: string) {
    this._hour_project_name = value;
  }

  get hour_subproject_name(): string {
    return this._hour_subproject_name;
  }

  set hour_subproject_name(value: string) {
    this._hour_subproject_name = value;
  }

  get hour_client_name(): string {
    return this._hour_client_name;
  }

  set hour_client_name(value: string) {
    this._hour_client_name = value;
  }
